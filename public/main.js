...
function changeBackground(data) {
  ...
  if(condition == 113) {
    ...
    // CLOUDY CONDITIONS
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/cloudy.jpg)';
    else wrapper.style.background = 'url(./images/night/cloudy.jpg)';
  } else if (condition == 143 || condition == 248 || condition == 260) {
    // background image mist
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/mist.jpg';
    else wrapper.style.background = 'url(./images/night/mist.jpg';
    ...
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/rain.jpg';
    else wrapper.style.background = 'url(./images/night/heavy_rain.jpg';
  } else if(condition >= 305 && condition <= 308 || condition ===314 || condition == 356 || condition == 359 || condition == 182) {
    // background image heavy rain
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/heavy_rain.jpg';
    else wrapper.style.background = 'url(./images/night/heavy_rain.jpg';
  } else if(condition == 386 || condition == 389) {
    // background image rain with thunder
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/light_thunder.jpg)';
    else wrapper.style.background = 'url(./images/night/light_thunder.jpg)';
  } else if(condition == 200) {
    // thundery outbreak image
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/thundery_outbreak.jpg';
    else wrapper.style.background = 'url(./images/night/thundery_outbreak.jpg';
  } else if(condition == 179 || condition >= 323 && condition <= 329 || condition >= 362 && condition <= 368 || condition == 392) {
    // light snow
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/light_snow.jpg';
    else wrapper.style.background = 'url(./images/night/light_snow.jpg';
  } else if(condition == 227 || condition == 230 || condition >= 332 && condition <= 338 || condition == 371 || condition == 395) {
    // heavy snow
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/heavy_snow.jpg';
    else wrapper.style.background = 'url(./images/night/heavy_snow.jpg';
  } else if(condition == 350 || condition == 374 || condition == 377) {
    // ice palletes
    if(conditionDay === 'day') wrapper.style.background = 'url(./images/day/ice_pellete.jpg';
    else wrapper.style.background = 'url(./images/night/ice_pellete.jpg';
  }
